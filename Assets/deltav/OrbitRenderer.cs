...
public class OrbitRenderer : MonoBehaviour
{
    ...
    private float _axisOffset = 0;

    [SerializeField]
    [Tooltip("This offset will be applied in the direction of the x axis.")]
    ...
    //[SerializeField]
    //[Tooltip("Use world axis")]
    //private bool _useWorld = false;
    ...
    void Start()
    {
        ...
        //_line.useWorldSpace = this._useWorld;
    ...
    void Update()
    {
        if (_checkValuesChanged)
        {
            if (_previousSegmentsValue != _segments ||
                ...
                _previousOffsetValue != _axisOffset ||
    ...
    void CreatePoints()
    {
        ...
        for (int i = 0; i < (_segments + 1); i++)
        {
            ...
            {
                case Axis.X:
                    _line.SetPosition(i, new Vector3(z+ _xOffset, y, x));
                    break;
                case Axis.Y:
                    _line.SetPosition(i, new Vector3(y+ _xOffset, z, x));
                    break;
                case Axis.Z:
                    _line.SetPosition(i, new Vector3(x+ _xOffset, y, z));
                    break;
                default:
                    break;
            }
